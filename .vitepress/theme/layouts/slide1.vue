<template>
  <div class="screen screen-cover">
    <h1>
      <span class="purple">A</span>zur<span class="purple">L</span>ane<span class="purple">A</span>uto<span class="purple">S</span>cript
    </h1>
    <p class="desc">
      {{ frontmatter.home.desc }}
    </p>
    <div class="actions">
      <a class="action-button primary" :href="frontmatter.links.start">{{ frontmatter.home.start }}</a>
      <a class="action-button secondary" target="_blank" :href="frontmatter.links.download">{{ frontmatter.home.download }}</a>
      <a class="action-button secondary" target="_blank" :href="frontmatter.links.demo">{{ frontmatter.home.demo }}</a>
    </div>
